...
[![License](https://img.shields.io/github/license/flyve-mdm/android-mdm-dashboard.svg?&label=License)](https://github.com/flyve-mdm/android-mdm-dashboard/blob/master/LICENSE.md)
...
[![Greenkeeper badge](https://badges.greenkeeper.io/flyve-mdm/android-mdm-dashboard.svg)](https://greenkeeper.io/)
[![GitHub release](https://img.shields.io/github/release/flyve-mdm/android-mdm-dashboard.svg)](https://github.com/flyve-mdm/android-mdm-dashboard/releases)
...
For more information visit our [Official Website](http://flyve.org/android-mdm-dashboard/).

## Build Status

| **LTS** | **Bleeding Edge** |
|:---:|:---:|
| [![Build Status](https://circleci.com/gh/flyve-mdm/android-mdm-dashboard/tree/master.svg?style=svg)](https://circleci.com/gh/flyve-mdm/android-mdm-dashboard/tree/master) | [![Build Status](https://circleci.com/gh/flyve-mdm/android-mdm-dashboard/tree/develop.svg?style=svg)](https://circleci.com/gh/flyve-mdm/android-mdm-dashboard/tree/develop) |

## Installation

[<img src="https://user-images.githubusercontent.com/663460/26973322-4ddf78a4-4d16-11e7-8b58-4c03b4bc2490.png" alt="Get it on Google Play" height="60">](https://play.google.com/store/apps/details?id=org.flyve.admin.dashboard) [<img src="https://f-droid.org/badge/get-it-on.png" alt="Get it on F-Droid" height="60">](https://f-droid.org/app/org.flyve.admin.dashboard) [<img src="https://user-images.githubusercontent.com/663460/26973090-f8fdc986-4d14-11e7-995a-e7c5e79ed925.png" alt="Download APK from GitHub" height="60">](https://github.com/flyve-mdm/android-mdm-dashboard/releases/latest)

## Documentation

We maintain a detailed documentation of the project on the website, check the [How-tos](http://flyve.org/android-mdm-dashboard/howtos/) and [Development](http://flyve.org/android-mdm-dashboard/) section.

## Versioning

In order to provide transparency on our release cycle and to maintain backward compatibility, Flyve MDM is maintained under [the Semantic Versioning guidelines](http://semver.org/). We are committed to following and complying with the rules, the best we can.

See [the tags section of our GitHub project](https://github.com/flyve-mdm/android-mdm-dashboard/tags) for changelogs for each release version of Flyve MDM. Release announcement posts on [the official Teclib' blog](http://www.teclib-edition.com/en/communities/blog-posts/) contain summaries of the most noteworthy changes made in each release.
...
guidelines for [contributing](./CONTRIBUTING.md) and then check out one of our issues in the [Issues Dashboard](https://github.com/flyve-mdm/android-mdm-dashboard/issues).
