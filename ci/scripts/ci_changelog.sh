...
#  LICENSE
#
#  This file is part of Flyve MDM Dashboard for Android.
#
#  Flyve MDM Dashboard for Android is a subproject of Flyve MDM. Flyve MDM is a mobile
...
#
#  Flyve MDM Dashboard for Android is distributed in the hope that it will be useful,
